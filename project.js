// command lines to set up the environment for the project
// > npm init
// > npm i prompt-sync
...
// implement the variables for columns & rows
const ROWS = 3, cols = 3;

// how mny symbols are in the machine
const symbolCount = {
        A: 2,
        B: 4,
        C: 6,
